  ...
  <div class="container-fluid p-0 m-0">
    ...
    <div class="container bg-white p-5">
        <div class="row jumbotron bg-light">
            <div class="col-sm-12">
                <h1 class="text-center">POO - Blog</h1>
        ...
        <div class="row bg-light mt-4">
            ...
            <div class="col-12">
                    ...
                    $article1->setContenu('Lorem ipsum sit dolor sit amet');
        ...
        <div class="row bg-light mt-4">
            ...
            <div class="col-12">
               ...
               $article2 = new Article('Découverte importante', 'Lorem ipsum sit dolor sit amet', '2021-04-12');
